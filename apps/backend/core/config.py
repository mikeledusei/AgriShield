...
class Settings(BaseSettings):
    ...
    MODEL_PATH: Path = PROJECT_ROOT / "ml-models" / "models" / "xgboost_agrishield_v1.joblib"
    ...
    def RISK_COLORS(self) -> dict:
        return {"CRITICAL": "#d32f2f", "HIGH": "#f57c00",
                "MODERATE": "#fbc02d", "SAFE": "#2e7d32"}

    @property
    def FEATURE_COLUMNS(self) -> list:
        return ["rainfall_anomaly_30d", "ndvi_pasture_index",
                "temp_max_avg", "soil_moisture_deficit"]
